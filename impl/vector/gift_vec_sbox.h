...
// can't really use vector registers here as
uint64_t   gift_64_vec_sbox_permute(const uint64_t cipher_state);
uint64_t   gift_64_vec_sbox_permute_inv(const uint64_t cipher_state);
